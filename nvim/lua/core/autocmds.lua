...
cmd({ "VimEnter", "FileType", "BufEnter", "WinEnter" }, {
  ...
  group = "highlighturl",
  pattern = "*",
  callback = function() coreutils.set_url_match() end,
})
...
cmd("BufEnter", {
  ...
  callback = function()
    ...
    local sidebar_fts = { "aerial", "nvim-tree" }
    local sidebars = {}
...
create_command("ToggleHighlightURL", coreutils.toggle_url_match, { desc = "Toggle URL Highlights" })
