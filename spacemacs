  ...
  (setq-default
   ...
   '(sql
    ...
    ;;          cider-repl-buffer-size-limit 100)        ;; limit lines shown in REPL buffer
     ...
     (deft :variables deft-zettledeft t)
     (helm :variables
...
This function is called at the very end of Spacemacs initialization."
 (custom-set-variables
  ...
  '(org-capture-templates
    '(("s" "shelves")
      ("su" "URL" entry
       (file+function "daily-urls.org" org-reverse-datetree-goto-date-in-file)
       "* [[%^{URL}][%^{Description}]] %^g %?")
      ("n" "notes")
      ("ss" "Shortcut notes" entry
       (file+headline "shortcuts.org" "Shortcuts")
       "* %^{ShortcutTitle} %^g")
      ("nd" "Daily Notes" entry
       (file+function "daily-notes.org" org-reverse-datetree-goto-date-in-file)
       "* %^{Description} %^g
  Added: %T
  %?
")
      ("m" "Meeting" entry
       (file+headline "meeting-notes.org" "Meetings")
       "** MEETING %^{Description} %^g
  SCHEDULED: %^{Date}T
  %?
")
      ("t" "Task" entry
       (file+function "my-notes.org" org-reverse-datetree-goto-date-in-file)
       "* TODO %^{Description} %^gkanban:
  Added: %t
  %?
")))
  '(package-selected-packages
    '(all-the-icons doom-themes tide typescript-mode prettier-js npm-mode nodejs-repl livid-mode skewer-mode simple-httpd json-reformat json-navigator hierarchy json-mode json-snatcher js2-refactor multiple-cursors js2-mode js-doc yaml-mode yasnippet-snippets which-key use-package unfill treemacs-projectile treemacs-magit treemacs-icons-dired treemacs-evil smeargle reveal-in-osx-finder rainbow-mode rainbow-identifiers quickrun parinfer-rust-mode overseer osx-trash osx-dictionary osx-clipboard nameless mwim mmm-mode markdown-toc magit-todos magit-gitflow magit-delta macrostep lsp-ui lsp-origami launchctl inspector hybrid-mode helm-xref helm-themes helm-swoop helm-projectile helm-org helm-mode-manager helm-make helm-lsp helm-ls-git helm-git-grep helm-flx helm-descbinds helm-company helm-c-yasnippet helm-ag godoctor go-tag go-rename go-impl go-guru go-gen-test go-fill-struct go-eldoc gitignore-templates git-timemachine git-modes git-messenger git-link git-gutter-fringe gh-md fuzzy forge flyspell-correct-helm flycheck-pos-tip flycheck-package flycheck-golangci-lint flycheck-elsa evil-mc emr elisp-slime-nav dotenv-mode diminish dap-mode company-go color-identifiers-mode browse-at-remote bind-map auto-yasnippet auto-dictionary auto-compile ace-jump-helm-line ac-ispell))
